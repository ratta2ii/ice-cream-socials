                    ...
                    <Grid item xs={12} md={6}>
                        <Box className={classes.textContent}>
                            ...
                            <Typography className={classes.subtext}>
                                Our Creamers, dressed in vintage Soda Jerk attire, deliver a sundae service as elegant as it is fun. We bring the charm of an old-school soda fountain to your modern event, complete with upscale decor.
                            </Typography>
